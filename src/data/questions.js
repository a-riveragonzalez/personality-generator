export const questions = [
  {
    ...
    choices: [
      ...
      { answer: "Graphic novel / fantasy", personalityType: "Jumping jackalope", points: 1 },
      { answer: "Historical / philosophical", personalityType: "Bottomless Book", points: 1 },
      { answer: "Horror", personalityType: "Soul Muncher", points: 1 },
      { answer: "Humor", personalityType: "Crystal Bubble", points: 1 }
    ]
  },
  {
    _id: "2",
    ...
    choices: [
      ...
      { answer: "Dragon", personalityType: "Jumping jackalope", points: 1 },
      { answer: "Elephant", personalityType: "Bottomless Book", points: 1 },
      { answer: "Tiger", personalityType: "Soul Muncher", points: 1 },
      { answer: "Fox", personalityType: "Crystal Bubble", points: 1 }
    ]
  },
  {
    _id: "3",
    ...
    choices: [
      ...
      { answer: "Purple", personalityType: "Jumping jackalope", points: 1 },
      { answer: "White", personalityType: "Bottomless Book", points: 1 },
      { answer: "Black", personalityType: "Soul Muncher", points: 1 },
      { answer: "Orange", personalityType: "Crystal Bubble", points: 1 }
    ]
  },
  {
    _id: "4",
    ...
    choices: [
      ...
      { answer: "Playful", personalityType: "Jumping jackalope", points: 1 },
      { answer: "Intellectual", personalityType: "Bottomless Book", points: 1 },
      { answer: "Aggressive", personalityType: "Soul Muncher", points: 1 },
      { answer: "Confident", personalityType: "Crystal Bubble", points: 1 }
    ]
  },
  {
    _id: "5",
    ...
    choices: [
      ...
      { answer: "The Fool", personalityType: "Jumping jackalope", points: 1 },
      { answer: "The Wheel of Fortune", personalityType: "Bottomless Book", points: 1 },
      { answer: "The Devil", personalityType: "Soul Muncher", points: 1 },
      { answer: "The hanged Man", personalityType: "Crystal Bubble", points: 1 }
    ]
  },
  {
    _id: "6",
    ...
    choices: [
      ...
      { answer: "Fire", personalityType: "Jumping jackalope", points: 1 },
      { answer: "Air", personalityType: "Bottomless Book", points: 1 },
      { answer: "Earth", personalityType: "Soul Muncher", points: 1 },
      { answer: "Water", personalityType: "Crystal Bubble", points: 1 }
    ]
  },
  {
    _id: "7",
    ...
    choices: [
      ...
      { answer: "Dancing, drinking, overall enjoying the environment and the people, having a great time", personalityType: "Jumping jackalope", points: 1 },
      { answer: "You were brought by a friend and have little interest in actually being there", personalityType: "Bottomless Book", points: 1 },
      { answer: "Rifling through the drawers/house/others belonging to get information on others", personalityType: "Soul Muncher", points: 1 },
      { answer: "Challenging other to  party/drinking games and making new friends", personalityType: "Crystal Bubble", points: 1 }
    ]
  },
  {
    _id: "8",
    ...
    choices: [
      ...
      { answer: "Pop", personalityType: "Jumping jackalope", points: 1 },
      { answer: "Audiobooks", personalityType: "Bottomless Book", points: 1 },
      { answer: "Heavy metal", personalityType: "Soul Muncher", points: 1 },
      { answer: "Country", personalityType: "Crystal Bubble", points: 1 }
    ]
  },
  {
    _id: "9",
    ...
    choices: [
      ...
      { answer: "A fun birthday party/celebration", personalityType: "Jumping jackalope", points: 1 },
      { answer: "A vast, mystical library", personalityType: "Bottomless Book", points: 1 },
      { answer: "A night with someone walking alone, a single streetlight above", personalityType: "Soul Muncher", points: 1 },
      { answer: "Pandoras box", personalityType: "Crystal Bubble", points: 1 }
    ]
  },
  {
    _id: "10",
    ...
    choices: [
      ...
      { answer: "The city", personalityType: "Jumping jackalope", points: 1 },
      { answer: "The desert", personalityType: "Bottomless Book", points: 1 },
      { answer: "Caverns/caves", personalityType: "Soul Muncher", points: 1 },
      { answer: "Grasslands", personalityType: "Crystal Bubble", points: 1 }
    ]
  },
  {
    _id: "11",
    ...
    choices: [
      ...
      { answer: "Ability to fly/super speed", personalityType: "Jumping jackalope", points: 1 },
      { answer: "To have limitless knowledge – know the answer by thinking about it", personalityType: "Bottomless Book", points: 1 },
      { answer: "To steal abilities from others", personalityType: "Soul Muncher", points: 1 },
      { answer: "Super strength", personalityType: "Crystal Bubble", points: 1 }
    ]
  },
  {
    _id: "12",
    ...
    choices: [
      ...
      { answer: "All day", personalityType: "Jumping jackalope", points: 1 },
      { answer: "Mid day", personalityType: "Bottomless Book", points: 1 },
      { answer: "Middle of the night", personalityType: "Soul Muncher", points: 1 },
      { answer: "Morning", personalityType: "Crystal Bubble", points: 1 }
    ]
  },
  {
    _id: "13",
    ...
    choices: [
      ...
      { answer: "Make more free time for family/friends/play and less work", personalityType: "Jumping jackalope", points: 1 },
      { answer: "Create a highly advance and educated society", personalityType: "Bottomless Book", points: 1 },
      { answer: "Burn everything to the ground", personalityType: "Soul Muncher", points: 1 },
      { answer: "Build a strong foundation of equality and change to a prosperous future", personalityType: "Crystal Bubble", points: 1 }
    ]
  }
